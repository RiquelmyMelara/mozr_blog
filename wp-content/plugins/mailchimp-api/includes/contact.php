<div class="col-xs-12 post-cont">
    ...
    <div class="container margin-bottom-50 margin-top-80">
        ...
        <div class="col-sm-6 contact-grey-bk-1 padding-35 margin-top-50-mobil">
            ...
            Subject* <input id="contact_sbjt" class="contact-input" type="text" name="subject"><br>
            Message* <textarea id="contact_messg" class="contact-input" rows="6" cols="20" name="message"></textarea><br>
