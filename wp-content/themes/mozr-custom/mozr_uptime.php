...
<div class=""> <!-- row -->
   <div id="content" class="container">
        ...
        <div class="col-xs-12 col-md-8 col-md-offset-2 post-cont">
            ...
            <p>Not only does Mozr provide superior uptime guarantees, but our AWS hosting also contains
            monitoring services in case of an event. Amazon monitoring provides a way for Mozr and you
            to identify an event before it becomes a disaster. It gives us and AWS IT the ability to remedy
            the situation before downtime occurs.</p>
