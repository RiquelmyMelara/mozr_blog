<?php
 /*
 Template Name: MOZR CDN
 */
 get_header(); ?>

</div><!-- Content  -->
    <img src="<?php echo get_stylesheet_directory_uri() ?>/img/CDN_image.jpg"  alt="">
    <div class="container jb-mobile" style="margin-top: 90px">
    
        <div class="col-md-6 mozr-page-title">
            <h1 class="white">
            Contend Delivery Network for<br>
...
<div class="col-xs-12 post-cont CDN-container">
    <div class="container">
        ...
        <img class="mozr-template-icon" src="<?php echo get_stylesheet_directory_uri() ?>/img/webcontent_CDN-03.png"  alt="">
            ...
            around-the-clock security at both
    ...
    <div class="container margin-bottom-50">
        ...
        <img class="mozr-template-icon" src="<?php echo get_stylesheet_directory_uri() ?>/img/webcontent_CDN-07.png"  alt="">
            ...
            for site configurations and setup.</p>
        </div>
    </div>
</div>
