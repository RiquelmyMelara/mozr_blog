...
<div class="col-xs-12 post-cont">
    ...
    <div class="container margin-bottom-50">
        <div class="col-sm-4">
        <h4 class="mozr-grey-bk legal-button">Terms of Service</h4>
        <h4 class="mozr-grey-bk legal-button legal-active">Service Level Agreement</h4>
        <h4 class="mozr-grey-bk legal-button">Privacy and Copyright</h4>
        <h4 class="mozr-grey-bk legal-button">Acceptable Use Policy</h4>
        </div>
